...
export function FlightInformation({ flight }: { flight: IFlight }) {
  return (
    <div className="my-3.5 text-sm sm:text-sm">
      ...
      <div className="grid grid-cols-2 gap-1 mb-1">
        <div className="bg-details p-mini-element flex items-center justify-between rounded-bl-xl">
          <p className="text-muted-foreground">Speed</p>
          <p>870 km/h</p>
        </div>
        <div className="bg-details p-mini-element flex items-center justify-between rounded-br-xl">
